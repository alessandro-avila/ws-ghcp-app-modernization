...
#Requires -Module @{ModuleVersion = '12.2.0'; ModuleName = 'Az'}
#Requires -version 7
...
param (
    ...
    [Parameter()][string]$ResourceGroupName = "migr-lab-rg",
    # Provide the name of the virtual machine
    [Parameter()][string]$VMName = "migr-lab-vm",
    ...
    [Parameter()][string]$StorageContainerName = "lab-vm-resources",
...
if (-not $DestinationFileName) {
    $DestinationFileName = "$(Get-Date -Format "yyyyMMddHHmmss")-osdisk.vhd"
}
...
Write-Host "Using current user authentication to access storage account."
